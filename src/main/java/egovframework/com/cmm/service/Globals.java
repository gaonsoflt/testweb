...
public class Globals {
	...
	public static final String MEDC_ServerIP = EgovProperties.getProperty("MEDC.ServerIP");
	public static final String MEDC_ServerPort = EgovProperties.getProperty("MEDC.ServerPort");
	public static final String Filepath_root = EgovProperties.getProperty("Filepath.root");
	public static final String Filepath_ecgdir = EgovProperties.getProperty("Filepath.ecgdir");
	public static final String Filepath_actecgdir = EgovProperties.getProperty("Filepath.actecgdir");
	public static final String Filepath_BaseDir = EgovProperties.getProperty("Filepath.BaseDir");
	public static final String Filepath_ECGDir = EgovProperties.getProperty("Filepath.ECGDir");
	public static final String Filepath_ECGUrl = EgovProperties.getProperty("Filepath.ECGUrl");
