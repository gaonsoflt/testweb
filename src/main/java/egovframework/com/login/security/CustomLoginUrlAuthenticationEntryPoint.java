...
public class CustomLoginUrlAuthenticationEntryPoint implements AuthenticationEntryPoint, InitializingBean {
    ...
    protected String buildRedirectUrlToLoginPage(HttpServletRequest request, HttpServletResponse response,
        ...
        DefaultSavedRequest defaultSaveRequest = (DefaultSavedRequest) request.getSession().getAttribute("SPRING_SECURITY_SAVED_REQUEST");
        if(defaultSaveRequest != null && defaultSaveRequest.getQueryString() != null) {
        	urlBuilder.setQuery(defaultSaveRequest.getQueryString());
        }
