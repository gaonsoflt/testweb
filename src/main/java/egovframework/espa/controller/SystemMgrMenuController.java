...
import egovframework.espa.service.SystemMgrMenuService;
import egovframework.espa.service.impl.SystemMgrMenuMapper;
...
Logger logger = LoggerFactory.getLogger(SystemMgrMenuController.class.getName());
	...
	public ModelAndView menuInfo(Model model) throws Exception {
		return new ModelAndView("espa/systemmgr/menu");
	}
