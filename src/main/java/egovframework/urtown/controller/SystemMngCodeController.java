...
@Controller
public class SystemMngCodeController {
	Logger logger = LoggerFactory.getLogger(SystemMngCodeController.class.getName());
    
	@Resource(name = "systemMngCodeService")
	private SystemMngCodeService systemMngCodeService;

	@RequestMapping(value = "/urtown/systemMngCode.do")
	public String dgmsMngCode(Model model) throws Exception {
		return "urtown/systemMngCode";
	}
	 ...
	 * @return
	 */
	@RequestMapping(value = "/urtown/selectMngCodeMasterInfoJsonp.do")
	 ...
	 * @return
	 */
	@RequestMapping(value = "/urtown/selectMngCodeDetailInfoJsonp.do")
	 ...
	 * @return
	 */
	@RequestMapping(value = "/urtown/insertMngCodeInfoJsonp.do")
	 ...
	 * @return
	 */
	@RequestMapping(value = "/urtown/updateMngCodeInfoJsonp.do")
	 ...
	 * @return
	 */
	@RequestMapping(value = "/urtown/deleteMngCodeInfoJsonp.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/urtown/selectCdNmCombo.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/urtown/selectCdNmComboJsonp.do")
	...
	@RequestMapping(value = "/urtown/selectMngCodeInfo.do")
...
/*		if( Objects.equals(rtnList.size(),0)){
	...
	@RequestMapping(value = "/urtown/selectMngCodeInfoCombo.do")
...
/*	@RequestMapping(value = "/dgms/updateMngCodeInfo.do", method=RequestMethod.POST)
	...
	@RequestMapping(value = "/urtown/updateMngCodeInfo.do", method=RequestMethod.POST)
	...
	@RequestMapping(value = "/urtown/insertMngCodeInfo.do", method=RequestMethod.POST)
	...
	@RequestMapping(value = "/urtown/deleteMngCodeInfo.do", method=RequestMethod.POST)
