...
@Controller
public class SystemMngUserController {
Logger logger = LoggerFactory.getLogger(SystemMngUserController.class.getName());
    
	@Resource(name = "systemMgrUserService")
	private SystemMgrUserService systemMngUserService;

	@RequestMapping(value = "/urtown/systemMngUser.do")
	public String systemMngUser(Model model) throws Exception {
		return "espa/systemMngUser";
	}
	 ...
	 * @return
	 */
	@RequestMapping(value = "/urtown/selectMngUserDetailInfoJsonp.do")
	public @ResponseBody JSONPObject  selectMngUserDetailInfoJsonp(@RequestParam("callback") String c, @RequestParam("params") String params) {
		...
		try {
			...
			rtnMap.put("total", systemMngUserService.selectSystemMngUserInfoTot((HashMap<String, Object>)paramMap));
