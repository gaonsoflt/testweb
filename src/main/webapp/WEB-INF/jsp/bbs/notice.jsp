...
<div id="window">
	...
	<table style="width:100%;">
		...
		<tbody>
			...
			<tr><td colspan="4"><textarea id="content" name="content" data-bind="value:selected.content" placeholder="내용을 입력하시고 [저장]버튼을 눌러주세요." style="width:100%;height:500px;"></textarea></td></tr>
		</tbody>
	</table>
</div>
