...
<body class="external-page sb-l-c sb-r-c">
	...
	<!-- jQuery -->
	<script src="<c:url value='/resource/css/espa/vendor/jquery/jquery-1.11.1.min.js'/>"></script>
	<script src="<c:url value='/resource/css/espa/vendor/jquery/jquery_ui/jquery-ui.min.js'/>"></script>

	<!-- CanvasBG Plugin(creates mousehover effect) -->
	<script src="<c:url value='/resource/css/espa/vendor/plugins/canvasbg/canvasbg.js'/>"></script>

	<!-- Theme Javascript -->
	<script src="<c:url value='/resource/css/espa/assets/js/utility/utility.js'/>"></script>
	<script src="<c:url value='/resource/css/espa/assets/js/demo/demo.js'/>"></script>
