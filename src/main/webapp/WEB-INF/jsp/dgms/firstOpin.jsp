...
$(document).ready(function(){
	$('#firstOpin').parent().parent().addClass('active');
	$('#firstOpin').addClass('active');
});	
</script>
                ...
                <div id="splitter" style="height:500px">
					...
					<div id="example">
	                	<div id="detl-form">
	                		...
	                		<div class="row">
		                		<div class="form-group" style="margin-top:10px;margin-left:10px;">
									<label for="OPINION" class="col-xs-1 control-label" style="min-width:80px;padding-right:5px;">검진소견:</label>
									<div class="col-xs-11">
									<textarea id="OPINION" name="OPINION" data-bind="value:dataSource.view()[0].OPINION" required validationMessage="필수입력 항목입니다." rows="5" class="k-textbox" style="width: 100%"></textarea>
...
/* 							if (!confirm("변경된 데이타를 저장하시겠습니까?")) {  
				...
				/* 안씀
				function fn_searchDetail(user_id){
					
					console.log(user_id);
					
					$.ajax({
		    			type: "post",
		    			url: "<c:url value='/dgms/selectFirstOpinDetail.do'/>",
		    			data: { "USER_ID" : user_id },
		    			async: false, //동기 방식
		    			success: function(data,status){
		    				var rtn = data.rtnList;
		    				
		    				$("#HOSP_NM").val(rtn.HOSP_NM);	$("#DOCTOR_NM").val(rtn.DOCTOR_NM);	$("#CHECKUP_DT").val(rtn.CHECKUP_DT);
		    				$("#OPINION_WRITER").val(rtn.OPINION_WRITER);	$("#OPINION").val(rtn.OPINION);
		    			},
