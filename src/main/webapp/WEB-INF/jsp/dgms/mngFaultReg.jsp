...
$(document).ready(function(){
	$('#mngFaultReg').parent().parent().addClass('active');
	$('#mngFaultReg').addClass('active');
});	
</script>
...
*/
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            <i class="fa fa-caret-right"></i>서비스장애등록
            <small>서비스 장애내용에 대해서 등록함</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> 안전서비스</a></li>
            <li class="active">서비스장애등록</li>
          </ol>
        </section>
        <!-- Main content -->
...
<!--                   <table id="example1" class="table table-bordered table-striped">
				...
				시작일자: <input id="fromdate" name="fromdate" />
				~ 종료일자: <input id="todate" name="todate"/>&nbsp;&nbsp;&nbsp;
					    ...
					    <div style="margin-top :10px;">
					        ...
					        <div class="row" style="margin-top:10px;margin-left:10px;">
						        <div class="col-xs-5" >
						            ...
						            <input id="ACCEPTER_ID" name="ACCEPTER_ID" data-bind="value: selected.ACCEPTER_ID" required readonly="readonly"/>
						        </div>
						        <div class="col-xs-5" >
						            <label for="ACCEPT_DT" class="col-xs-1 control-label" style="min-width:80px;padding-right:5px;">접수일</label>
						        	<input id="ACCEPT_DT" type="text" name="ACCEPT_DT" data-bind="value: selected.ACCEPT_DT" required readonly="readonly"/>
						        </div>
					        </div>
					        <div class="row" style="margin-top:10px;margin-left:10px;">
						        <div class="col-xs-11" >    
					        ...
					        <div class="row" style="margin-top:10px;margin-left:10px;">
						        <div class="col-xs-5">
						            ...
						            <input id="RESULT_STATE" type="text" name="RESULT_STATE" data-bind="value: selected.RESULT_STATE" readonly="readonly"/>
						        </div>
						    </div>
					        <div class="row" style="margin-top:10px;margin-left:10px;">
						        <div class="col-xs-5">
						            <label for="WORK_DT" class="col-xs-1 control-label" style="min-width:80px; padding-right:5px;">처리일자</label>
						            <input id="WORK_DT" type="text"  name="WORK_DT" data-bind="value: selected.WORK_DT" readonly="readonly"/>
						        </div>
						        <div class="col-xs-5">
						        	<label for="WORKER_ID" class="col-xs-1 control-label" style="min-width:80px; padding-right:5px;">처리자</label>
						            <input id="WORKER_ID" type="text" name="WORKER_ID" data-bind="value: selected.WORKER_ID" readonly="readonly"/>
						        </div>
						    </div>
						    <div class="row" style="margin-top:10px;margin-left:10px;">
						   		 <div class="col-xs-11">
						            <label for="RESULT" class="col-xs-1 control-label" style="min-width:80px;padding-right:5px;">처리결과</label>
						            <textarea class="k-textbox" rows="5" style="width: 100%" name="RESULT" data-bind="value: selected.RESULT" readonly="readonly"></textarea>
						            <!-- <span>Items is discontinued</span> -->
						       	</div>
						    </div>
					    </div>
                ...
                $(document).ready(function () {
                    ...
                    var userModel = kendo.data.Model.define({
                        ...
                        fields: {
                            ...
                            ACCEPT_DT: { validation: { required: true } },
                            WORKER_ID: { },
                            WORK_DT: { },
                            RESULT: { },
                    ...
                    var viewModel = kendo.observable({
                                ...
                                parameterMap: function(options, operation) {
                                	if (operation == "read"){
                                       	var result = {
                                            ...
                                            //ACCEPTER_ID: "${userStore.username}"
                                       	};
                						return { params: kendo.stringify(result) }; 
                					}
                        ...
                        newsync: function () {
                        	...
                        	//var combobox = $("#ACCEPTER_ID").data("kendoComboBox");
                        	//combobox.value("${userStore.username}");
