      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            ...
            <small>시스템 로그인 사용자를 관리합니다.</small>
          </h1>
          <ol class="breadcrumb">
...
/* 					$("#gridMaster").on("click", "table", function(e) {
					...
					var url = "<c:url value='/dgms/getCodeListByCdIDModel.do'/>";
					var parameters = {CD_ID: "_SEX_", USE_YN: "1"};
					$.post(url, parameters, function(data) {
						sexModles = data.rtnList;
					}); 

					function fnSexName(sex){
						var rtnVal = "";
						for (var i = 0; i < sexModles.length; i++) {
				            if (sexModles[i].CD_ID == sex) {
				            	rtnVal = sexModles[i].CD_NM;
				            }
				        }
						return rtnVal;
					}
