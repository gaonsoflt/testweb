...
$(document).ready(function(){
	$('#systemMngNotice').parent().parent().addClass('active');
	$('#systemMngNotice').addClass('active');
});	
</script>
              ...
              <div class="box">
						...
						<div style="margin :60px auto auto auto; width:80%;">
							<div class="row" style="margin-top:10px;margin-left:10px;">
								<div class="col-xs-5">    
						            ...
						            <input id="AREA_GB" name="AREA_GB" data-bind="value: selected.AREA_GB" required /> 
								</div> 
								<div class="col-xs-5" >
									<label for="NOTICE_SQ" class="col-xs-1 control-label" style="min-width:100px; padding-right:5px;">공지번호</label> 
									<input type="text" id="NOTICE_SQ" class="k-textbox col-xs-2" name="NOTICE_SQ" data-bind="value: selected.NOTICE_SQ" readonly />
							...
							<div class="row" style="margin-top:10px;margin-left:10px; display:none;">
								<div class="col-xs-5" >
						            ...
						            <input id="REG_USER_SQ" name="REG_USER_SQ" data-bind="value: selected.REG_USER_SQ" required readonly="readonly"/>
								</div>
								<div class="col-xs-5" >
							 ...
							 <div class="row" style="margin-top:10px;margin-left:10px;">
								<div class="col-xs-5" > 
									...
									<input id="START_DT" type="text" name="START_DT" data-bind="value: selected.START_DT" required />
								</div>
								<div class="col-xs-5" > 
									<label for="END_DT" class="col-xs-1 control-label" style="min-width:100px;  padding-right:5px;">공지종료일</label>
									<input id="END_DT" type="text" name="END_DT" data-bind="value: selected.END_DT" required />
								</div>
							</div> 
							<div class="row" style="margin-top:10px;margin-left:10px;">
								<div class="col-xs-5 w10" >    
									<label for="TITLE" class="col-xs-1 control-label" style="min-width:100px; padding-right:5px;">제목</label>
									<input type="text" id="TITLE" class="k-textbox col-xs-2" name="TITLE" data-bind="value: selected.TITLE" required />
								</div>
							</div>
							<div class="row" style="margin-top:10px;margin-left:10px;">
								<div class="col-xs-11" >     
				...
				<script>  
                    ...
                    var viewModel = kendo.observable({
                        ...
                        remove: function () {
                        	var key = this.selected.NOTICE_SQ;
                        ...
                        change: function (e) {
                            ...
                            if(selected.length> 0 && model.NOTICE_SQ !="" && model.NOTICE_SQ != null && model.RNUM != null){ 
    							...
    							$.ajax({
    							    ...
    							    type: 'POST',									// GET, PUT
    							    data: parameters,		
    							    contentType: "application/x-www-form-urlencoded; charset=UTF-8", 						// 전송할 데이터
    							...
    							$('.k-file').each(function(index){
    							    ...
    							    //var downPath = "<c:url value='/upload/" + data[1] + "' />";
    							    //var inData = '<a href="' + downPath + '" download="'+data[2]+'">'+data[2]+'</a>';
					...
					var loadFiles = "";
	                	...
	                	function createUpload(){
              				$('<input name="files" id="files" type="file" />').appendTo("#fileWrapper").kendoUpload({
		                        ...
		                        remove: function(e){  
		                        	e.data = { FILE_SQ : e.files[0].FILE_SQ };
		                        	alert("파일이 삭제되었습니다.");
		                        },
		                        success: function(e){ 
		                        	//File Clear
