...
<%--     <script src="<c:url value='/resource/dist/js/app.min.js'/>" type="text/javascript"></script> --%>
	...
	<!-- style neuboard -->
	<!-- Favicon -->
    <link rel="shortcut icon" href="<c:url value='/resource/style/neuboard/assets/img/favicon.ico'/>" type="image/x-icon">
    <!-- Bootstrap core CSS -->
<%--     <link rel="stylesheet" href="<c:url value='/resource/style/neuboard/assets/plugins/bootstrap/css/bootstrap.min.css'/>"> --%>
    <!-- Fonts  -->
    <link rel="stylesheet" href="<c:url value='/resource/style/neuboard/assets/css/font-awesome.min.css'/>">
    <link rel="stylesheet" href="<c:url value='/resource/style/neuboard/assets/css/simple-line-icons.css'/>">
    <!-- CSS Animate -->
<%--     <link rel="stylesheet" href="<c:url value='/resource/style/neuboard/assets/css/animate.css'/>"> --%>
    <!-- Daterange Picker -->
<%--     <link rel="stylesheet" href="<c:url value='/resource/style/neuboard/assets/plugins/daterangepicker/daterangepicker-bs3.css'/>"> --%>
    <!-- Calendar demo -->
<%--     <link rel="stylesheet" href="<c:url value='/resource/style/neuboard/assets/css/clndr.css'/>"> --%>
    <!-- Switchery -->
<%--     <link rel="stylesheet" href="<c:url value='/resource/style/neuboard/assets/plugins/switchery/switchery.min.css'/>"> --%>
    <!-- Custom styles for this theme -->
    <link rel="stylesheet" href="<c:url value='/resource/style/neuboard/assets/css/main.css'/>">
    <!-- Feature detection -->
<%--     <script src="<c:url value='/resource/style/neuboard/assets/js/vendor/modernizr-2.6.2.min.js'/>"></script> --%>
    <!-- HTML5 shim and Respond.js IE8 support of HTML5 elements and media queries -->
    <!--[if lt IE 9]>
