				...
				<div class="box">
					<div class="box-body">
						...
						<!-- 지도 표시 스크립트  -->
  						...
  						<script type="text/javascript" src="https://openapi.map.naver.com/openapi/v3/maps.js?clientId=jAA1UVojKld1S28BBje5"></script>
						<script> 
							...
							//CCTV 정보 조회
								...
								$.ajax({
									type: "get",
									url: "<c:url value='/urtown/selectMngCctvInfoJsonp2.do' />?param="+param,
									async: false, //동기 방식
								    dataType: 'jsonp',
									...
									success: function(data,status){ 
										...
										if(data["rtnList"].length == 0){ 
											...
											mapOptions = {
													//지도 중심 위치-임의로 덕실마을 위치
												    center: new naver.maps.LatLng(35.217252,128.671698), 	 
													zoom: 10,												  
													minZoom: 1, 											 
													zoomControl: true 										  
													/*
