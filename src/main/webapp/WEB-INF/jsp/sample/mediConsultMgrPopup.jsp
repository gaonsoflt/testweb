...
-->
	...
	<tbody id="detail-info">
		...
		<tr>
			<th style="text-align:center;">불편사항</th>
...
<div id="consultnote-form">
	<div><button id="savenote-btn" class="k-primary" style="float:right;margin:10px 10px 0 0;">상담내용 저장</button></div>
	<table class="tbl_default" style="width:100%;">
...
<script> 
	...
	function viewEcg(name, url){
	    var strWindowFeatures = "scrollbars=no,toolbar=no,location=no,resizable=yes,status=no,menubar=no,width=1040,height=860,left=690,top=0"; 
		var winobj = window.open("/urtown/mediConsultMgrPopupEcg.do?name="+name+"&url="+url, "mediConsultMgrPopupEcg", strWindowFeatures);
	}
